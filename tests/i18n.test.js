...
function testNewUiStringsAreLocalized() {
  ...
  assert.equal(t("cardForm.textLimitError"), "Текста слишком много, пожалуйста, добавьте дополнительную сторону.");
  assert.equal(t("alerts.textLimitExceeded"), "Текста слишком много, пожалуйста, добавьте дополнительную сторону.");
