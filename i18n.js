  ...
  const TRANSLATIONS = {
    en: {
      ...
      settings: {
        ...
        homeTiles3: "3",
        homeTiles4: "4",
        autoGermanArticle: "Automatically add articles to German nouns",
      ...
      addFromOther: {
        ...
        addCard: "Add",
        empty: "This deck has no cards to add yet."
      },
      study: {
        title: "Study mode",
        ...
        emptyQueue: "No cards left in this study session.",
      ...
      alerts: {
        ...
        libraryImportSummary: "Added {added} deck(s). Skipped {skipped} already in your library.",
        deckImportSummary: "Added {added} card(s). Skipped {skipped} already in this deck.",
        ...
        serverUnavailable: "Lookup is unavailable right now. Please try again in a moment.",
        nothingFound: "No results found. Try a different word or phrase.",
        ...
        cardsMoved: "Moved {added} card(s). Skipped {skipped} duplicate(s).",
        ...
        invalidImageUrl: "Use a valid image link.",
        noCardsForMode: "No cards are due for study right now.",
        deckMerged: "Decks merged into \"{name}\".",
        deckShared: "Deck shared.",
        deckJsonCopied: "Deck data copied to clipboard.",
        shareUnavailable: "This device can't share the deck here.",
    ...
    ru: {
      ...
      addFromOther: {
        ...
        addCard: "Добавить",
        empty: "В этой колоде пока нет карточек для добавления."
      },
      study: {
        ...
        emptyQueue: "В этой учебной сессии карточек больше нет.",
      ...
      alerts: {
        ...
        noCardsForMode: "Сейчас нет карточек, срок повторения которых уже наступил.",
        deckMerged: "Колоды объединены в \"{name}\".",
        deckShared: "Колода отправлена.",
        deckJsonCopied: "Данные колоды скопированы в буфер обмена.",
        shareUnavailable: "На этом устройстве не получилось поделиться колодой.",
    ...
    de: {
      ...
      cardForm: {
        ...
        deckLabel: "Deck",
        getDefinition: "Bedeutung nachschlagen",
      ...
      addFromOther: {
        ...
        addCard: "Hinzufügen",
        empty: "Dieses Deck hat noch keine Karten zum Hinzufügen."
      },
      study: {
        title: "Lernmodus",
        ...
        emptyQueue: "In dieser Lernsitzung sind keine Karten mehr übrig.",
      ...
      alerts: {
        ...
        noCardsForMode: "Im Moment sind keine Karten zum Wiederholen fällig.",
        deckMerged: "Decks wurden zu \"{name}\" zusammengeführt.",
        deckShared: "Deck geteilt.",
        deckJsonCopied: "Deck-Daten in die Zwischenablage kopiert.",
        shareUnavailable: "Auf diesem Gerät kann das Deck hier nicht geteilt werden.",
